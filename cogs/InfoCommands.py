...
class InfoCommands(commands.Cog):
    ...
    async def on_info(self, ctx):
        ...
        embed.add_field(name="__*!yesno*__", value="This reading will provide an answer to a yes or no question through the delivery of Ace cards. Out of three cards, if two of them are Ace cards, then the answer is *yes*. But if only one or none are Ace cards, then the answer is *no*")
        embed.set_footer(
